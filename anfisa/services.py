...
def what_conclusion(parsed_temperature):
    try:
        ...
        if temperature < 18:
            return 'холодно, ты на северном полюсе живёшь что ли?'
        elif 18 <= temperature <= 27:
            return 'в самый раз заточить мороженку'
        else:
            return 'Уф, да тут жарко как в жопе негра из Зимбабве, жри мороженку!'
